...
var rendererStmtTests = []struct {
	...
	{"{% for i := 0; i < 5; i = i + 1 %}{{ i }}{% end %}", "01234", nil},
	{"{% for i := 0; i < 5; i = i + 1 %}{{ i }}{% break %}{% end %}", "0", nil},
	{"{% for i := 0; ; i = i + 1 %}{{ i }}{% if i == 4 %}{% break %}{% end %}{% end %}", "01234", nil},
	{"{% for i := 0; i < 5; i = i + 1 %}{{ i }}{% if i == 4 %}{% continue %}{% end %},{% end %}", "0,1,2,3,4", nil},
	{"{% i := 0 %}{% c := true %}{% for c %}{% i = i + 1 %}{{ i }}{% c = i < 5 %}{% end %}", "12345", nil},
	{"{% i := 0 %}{% for ; ; %}{% i = i + 1 %}{{ i }}{% if i == 4 %}{% break %}{% end %},{% end %} {{ i }}", "1,2,3,4 4", nil},
	{"{# comment #}", "", nil},
	{"a{# comment #}b", "ab", nil},
	...
	{`{% if _, ok := slice(a).(slice); ok %}ok{% end %}`, "ok", scope{"a": MutableSlice(nil)}},
	...
	{`{% if _, ok := map(a).(map); ok %}ok{% end %}`, "ok", scope{"a": MutableMap(nil)}},
