...
var typeTests = map[string][]tokenType{
	...
	"{% var a = 1 %}":             {tokenStartStatement, tokenVar, tokenIdentifier, tokenAssignment, tokenInt32, tokenEndStatement},
	"{% a = 2 %}":                 {tokenStartStatement, tokenIdentifier, tokenAssignment, tokenInt32, tokenEndStatement},
	...
	"{{ 3 }}":                     {tokenStartShow, tokenInt32, tokenEndShow},
	"{{ -3 }}":                    {tokenStartShow, tokenSubtraction, tokenInt32, tokenEndShow},
	"{{ +3 }}":                    {tokenStartShow, tokenAddition, tokenInt32, tokenEndShow},
	"{{ 0 }}":                     {tokenStartShow, tokenInt32, tokenEndShow},
	"{{ 2147483647 }}":            {tokenStartShow, tokenInt32, tokenEndShow},
	"{{ 2147483648 }}":            {tokenStartShow, tokenInt64, tokenEndShow},
	"{{ 9223372036854775807 }}":   {tokenStartShow, tokenInt64, tokenEndShow},
	"{{ .0 }}":                    {tokenStartShow, tokenDecimal, tokenEndShow},
	"{{ 0. }}":                    {tokenStartShow, tokenDecimal, tokenEndShow},
	"{{ 0.0 }}":                   {tokenStartShow, tokenDecimal, tokenEndShow},
	"{{ 2147483647.2147483647 }}": {tokenStartShow, tokenDecimal, tokenEndShow},
	...
	"{{ a[5] }}":                  {tokenStartShow, tokenIdentifier, tokenLeftBrackets, tokenInt32, tokenRightBrackets, tokenEndShow},
	"{{ a() }}":                   {tokenStartShow, tokenIdentifier, tokenLeftParenthesis, tokenRightParenthesis, tokenEndShow},
	"{{ a(1) }}":                  {tokenStartShow, tokenIdentifier, tokenLeftParenthesis, tokenInt32, tokenRightParenthesis, tokenEndShow},
	"{{ a(1,2) }}":                {tokenStartShow, tokenIdentifier, tokenLeftParenthesis, tokenInt32, tokenComma, tokenInt32, tokenRightParenthesis, tokenEndShow},
