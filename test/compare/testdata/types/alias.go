...
func main() {
	...
	var _ SliceString = []int{} // ERROR `cannot use []int{} (type []int) as type []string in assignment`
	...
	var _ Int2 = Int2(0)
	var _ Int2 = 0
	var _ Int2 = SliceString{} // ERROR `cannot use SliceString{} (type []string) as type int in assignment`
