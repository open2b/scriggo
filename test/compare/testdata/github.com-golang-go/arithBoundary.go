...
func main() {
	...
	for _, v := range uint64_data {
		if got := add_uint64_ssa(v.a, v.b); got != v.add {
			log.Fatalf("add_uint64 %d+%d = %d, wanted %d\n", v.a, v.b, got, v.add)
		}
		if got := sub_uint64_ssa(v.a, v.b); got != v.sub {
			log.Fatalf("sub_uint64 %d-%d = %d, wanted %d\n", v.a, v.b, got, v.sub)
		}
		if v.b != 0 {
			if got := div_uint64_ssa(v.a, v.b); got != v.div {
				log.Fatalf("div_uint64 %d/%d = %d, wanted %d\n", v.a, v.b, got, v.div)
			}
