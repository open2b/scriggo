...
func testZero10() {
	...
	if a != want {
		log.Printf("zero10 got=%v, want %v\n", a, want)
	}
}
...
func testZero15() {
	...
	if a != want {
		log.Printf("zero15 got=%v, want %v\n", a, want)
	}
}
...
func testZero16() {
	...
	if a != want {
		log.Printf("zero16 got=%v, want %v\n", a, want)
	}
}
...
func testZero17() {
	...
	if a != want {
		log.Printf("zero17 got=%v, want %v\n", a, want)
	}
}
...
func testZero23() {
	...
	if a != want {
		log.Printf("zero23 got=%v, want %v\n", a, want)
	}
}
...
func testZero24() {
	...
	if a != want {
		log.Printf("zero24 got=%v, want %v\n", a, want)
	}
}
...
func testZero25() {
	...
	if a != want {
		log.Printf("zero25 got=%v, want %v\n", a, want)
	}
}
...
func testZero31() {
	...
	if a != want {
		log.Printf("zero31 got=%v, want %v\n", a, want)
	}
}
...
func testZero32() {
	...
	if a != want {
		log.Printf("zero32 got=%v, want %v\n", a, want)
	}
}
...
func testZero33() {
	...
	if a != want {
		log.Printf("zero33 got=%v, want %v\n", a, want)
	}
}
...
func testZero63() {
	...
	if a != want {
		log.Printf("zero63 got=%v, want %v\n", a, want)
	}
}
...
func testZero64() {
	...
	if a != want {
		log.Printf("zero64 got=%v, want %v\n", a, want)
	}
}
...
func testZero65() {
	...
	if a != want {
		log.Printf("zero65 got=%v, want %v\n", a, want)
	}
}
...
func testZero1023() {
	...
	if a != want {
		log.Printf("zero1023 got=%v, want %v\n", a, want)
	}
}
...
func testZero1024() {
	...
	if a != want {
		log.Printf("zero1024 got=%v, want %v\n", a, want)
	}
}
...
func testZero1025() {
	...
	if a != want {
		log.Printf("zero1025 got=%v, want %v\n", a, want)
	}
}
...
func testZero8u() {
	...
	if a != want {
		log.Printf("zero8u2 got=%v, want %v\n", a, want)
	}
...
func testZero16u() {
	...
	if a != want {
		log.Printf("zero16u2 got=%v, want %v\n", a, want)
	}
...
func testZero24u() {
	...
	if a != want {
		log.Printf("zero24u2 got=%v, want %v\n", a, want)
	}
...
func testZero32u() {
	...
	if a != want {
		log.Printf("zero32u2 got=%v, want %v\n", a, want)
	}
...
func testZero64u() {
	...
	if a != want {
		log.Printf("zero64u2 got=%v, want %v\n", a, want)
	}
...
func testZero256u() {
	...
	if a != want {
		log.Printf("zero256u2 got=%v, want %v\n", a, want)
	}
