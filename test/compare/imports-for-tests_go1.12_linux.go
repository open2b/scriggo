	...
	packages = scriggo.Packages{
		...
		"os": {
			...
			Declarations: map[string]interface{}{
				...
				"Create":            os.Create,
				"DevNull":           scriggo.ConstLiteral(nil, `"/dev/null"`),
				"Environ":           os.Environ,
				...
				"O_SYNC":            scriggo.ConstLiteral(reflect.TypeOf(new(int)).Elem(), "1052672"),
				...
				"PathListSeparator": scriggo.ConstLiteral(nil, "58"),
				"PathSeparator":     scriggo.ConstLiteral(nil, "47"),
				"Pipe":              os.Pipe,
