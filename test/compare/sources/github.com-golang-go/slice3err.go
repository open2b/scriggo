// skip : type checking errors are different from gc.
...
func f() {
	...
	_ = array[:j]
	_ = array[i:j]
	_ = array[::] // ERROR "middle index required in 3-index slice"
	_ = array[i::] // ERROR "middle index required in 3-index slice"
	...
	_ = slice[:j]
	_ = slice[i:j]
	_ = slice[::] // ERROR "middle index required in 3-index slice"
	_ = slice[i::] // ERROR "middle index required in 3-index slice"
