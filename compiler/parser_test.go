...
var treeTests = []struct {
	...
	{"{% include \"/a.b\" %}", ast.NewTree("", []ast.Node{ast.NewShowPartial(p(1, 4, 3, 16), "/a.b", ast.ContextHTML)}, ast.LanguageHTML)},
...
func pageTests() map[string]struct {
	...
	var include = ast.NewShowPartial(p(3, 7, 29, 58), "/include2.html", ast.ContextHTML)
