...
var exprTests = []struct {
	...
	{"func() {}",
		ast.NewFunc(p(1, 1, 0, 8), nil, ast.NewFuncType(nil, false, nil, nil, false), ast.NewBlock(p(1, 8, 7, 8), nil), false, ast.ContextText)},
	{"func(int) {}",
		ast.NewFunc(p(1, 1, 0, 11), nil, ast.NewFuncType(nil, false, []*ast.Parameter{ast.NewParameter(nil, ast.NewIdentifier(p(1, 6, 5, 7), "int"))}, nil, false), ast.NewBlock(p(1, 11, 10, 11), nil), false, ast.ContextText)},
	{"func(a int) {}",
		...
		}, nil, false), ast.NewBlock(p(1, 13, 12, 13), nil), false, ast.ContextText)},
	{"func(a, b int) {}",
		...
		}, nil, false), ast.NewBlock(p(1, 16, 15, 16), nil), false, ast.ContextText)},
	{"func(a string, b int) {}",
		...
		}, nil, false), ast.NewBlock(p(1, 23, 22, 23), nil), false, ast.ContextText)},
	{"func(a, b ...int) {}",
		...
		}, nil, true), ast.NewBlock(p(1, 19, 18, 19), nil), false, ast.ContextText)},
	{"func(p.T) {}",
		...
		}, nil, false), ast.NewBlock(p(1, 11, 10, 11), nil), false, ast.ContextText),
	},
	{"func(a p.T) {}",
	...
	{"func(a ...p.T) {}",
		...
		}, nil, true), ast.NewBlock(p(1, 15, 15, 16), nil), false, ast.ContextText),
	},
}
