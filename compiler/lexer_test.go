...
var typeTests = map[string][]tokenTyp{
	...
	"{% if not a %}":               {tokenStartStatement, tokenIf, tokenRelaxedNot, tokenIdentifier, tokenEndStatement},
	"{% if not 10 + 3 %}":          {tokenStartStatement, tokenIf, tokenRelaxedNot, tokenInt, tokenAddition, tokenInt, tokenEndStatement},
	...
	"{{ a[5] }}":             {tokenStartValue, tokenIdentifier, tokenLeftBracket, tokenInt, tokenRightBracket, tokenEndValue},
	...
	"{{ []*int{} }}":        {tokenStartValue, tokenLeftBracket, tokenRightBracket, tokenMultiplication, tokenIdentifier, tokenLeftBrace, tokenRightBrace, tokenEndValue},
	"{{ $a }}":              {tokenStartValue, tokenDollar, tokenIdentifier, tokenEndValue},
	"{{ a[\"5\"] }}":        {tokenStartValue, tokenIdentifier, tokenLeftBracket, tokenInterpretedString, tokenRightBracket, tokenEndValue},
	"{{ a[:] }}":            {tokenStartValue, tokenIdentifier, tokenLeftBracket, tokenColon, tokenRightBracket, tokenEndValue},
	"{{ a[:8] }}":           {tokenStartValue, tokenIdentifier, tokenLeftBracket, tokenColon, tokenInt, tokenRightBracket, tokenEndValue},
	"{{ a[3:] }}":           {tokenStartValue, tokenIdentifier, tokenLeftBracket, tokenInt, tokenColon, tokenRightBracket, tokenEndValue},
	"{{ a[3:8] }}":          {tokenStartValue, tokenIdentifier, tokenLeftBracket, tokenInt, tokenColon, tokenInt, tokenRightBracket, tokenEndValue},
	...
	"{{ map{} }}":            {tokenStartValue, tokenMap, tokenLeftBrace, tokenRightBrace, tokenEndValue},
	"{{ map{`a`: 6} }}":      {tokenStartValue, tokenMap, tokenLeftBrace, tokenRawString, tokenColon, tokenInt, tokenRightBrace, tokenEndValue},
	"{{ interface{} }}":      {tokenStartValue, tokenInterface, tokenLeftBrace, tokenRightBrace, tokenEndValue},
	...
	"{{ a contains b }}":     {tokenStartValue, tokenIdentifier, tokenContains, tokenIdentifier, tokenEndValue},
	"{{ a not contains b }}": {tokenStartValue, tokenIdentifier, tokenRelaxedNot, tokenContains, tokenIdentifier, tokenEndValue},
...
var contextTests = map[ast.Context]map[string][]ast.Context{
	...
	ast.ContextHTML: {
		...
		`<style a="{{b}}"></style>`:                    {ast.ContextText, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextText},
		`<style a="b">{{1}}</style>`:                   {ast.ContextText, ast.ContextCSS, ast.ContextCSS, ast.ContextCSS, ast.ContextText},
		`<script a="{{b}}"></script>`:                  {ast.ContextText, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextText},
		...
		`<a href="">`:                                  {ast.ContextText, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextText},
		`<A Href="">`:                                  {ast.ContextText, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextText},
		`<a href=''>`:                                  {ast.ContextText, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextText},
		`<a href="u">`:                                 {ast.ContextText, ast.ContextQuotedAttribute, ast.ContextText, ast.ContextQuotedAttribute, ast.ContextText},
		`<a href='u'>`:                                 {ast.ContextText, ast.ContextQuotedAttribute, ast.ContextText, ast.ContextQuotedAttribute, ast.ContextText},
		`<a href="{{ u }}">`:                           {ast.ContextText, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextText},
		...
		`<a href="a{{ p }}">`:                          {ast.ContextText, ast.ContextQuotedAttribute, ast.ContextText, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextText},
		`<a href="{% if a %}b{% end %}">`:              {ast.ContextText, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextText, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextText},
		...
		`<a {% if a %}b=""{% end %}>`:                  {ast.ContextText, ast.ContextTag, ast.ContextTag, ast.ContextTag, ast.ContextTag, ast.ContextText, ast.ContextTag, ast.ContextTag, ast.ContextTag, ast.ContextText},
		`<a {% if a %}b=''{% end %}>`:                  {ast.ContextText, ast.ContextTag, ast.ContextTag, ast.ContextTag, ast.ContextTag, ast.ContextText, ast.ContextTag, ast.ContextTag, ast.ContextTag, ast.ContextText},
		`<a class="{{ a }}">`:                          {ast.ContextText, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextText},
		`<a class="c">{{ a }}`:                         {ast.ContextText, ast.ContextHTML, ast.ContextHTML, ast.ContextHTML},
		`<a class='c'>{{ a }}`:                         {ast.ContextText, ast.ContextHTML, ast.ContextHTML, ast.ContextHTML},
		`<a class=c>{{ a }}`:                           {ast.ContextText, ast.ContextHTML, ast.ContextHTML, ast.ContextHTML},
		`<input type="text" disabled class="{{ a }}">`: {ast.ContextText, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextText},
		`<input type="text" data-value="{{ a }}">`:     {ast.ContextText, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextText},
		...
		`<script type="application/ld+json" a="{{b}}"></script>`:       {ast.ContextText, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextQuotedAttribute, ast.ContextText},
