...
var typeTests = map[string][]tokenTyp{
	...
	"{{ a and b }}":          {tokenLeftBraces, tokenIdentifier, tokenRelaxedAnd, tokenIdentifier, tokenRightBraces},
	"{{ a or b }}":           {tokenLeftBraces, tokenIdentifier, tokenRelaxedOr, tokenIdentifier, tokenRightBraces},
	"{{ a or not b }}":       {tokenLeftBraces, tokenIdentifier, tokenRelaxedOr, tokenRelaxedNot, tokenIdentifier, tokenRightBraces},
	"{{ a contains b }}":     {tokenLeftBraces, tokenIdentifier, tokenContains, tokenIdentifier, tokenRightBraces},
	"{{ a not contains b }}": {tokenLeftBraces, tokenIdentifier, tokenRelaxedNot, tokenContains, tokenIdentifier, tokenRightBraces},
