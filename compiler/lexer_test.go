...
var contextTests = map[ast.Ctx]map[string][]ast.Ctx{
	ast.CtxText: {
		`a`:                             {ast.CtxText},
		`{{a}}`:                         {ast.CtxText, ast.CtxText, ast.CtxText},
		"<script></script>":             {ast.CtxText},
		"<style></style>":               {ast.CtxText},
		"<script>s{{a}}t</script>{{a}}": {ast.CtxText, ast.CtxText, ast.CtxText, ast.CtxText, ast.CtxText, ast.CtxText, ast.CtxText, ast.CtxText},
		"<style>s{{a}}t</style>{{a}}":   {ast.CtxText, ast.CtxText, ast.CtxText, ast.CtxText, ast.CtxText, ast.CtxText, ast.CtxText, ast.CtxText},
	},
	ast.CtxHTML: {
		`a`:                                            {ast.CtxText},
		`{{a}}`:                                        {ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		"<script></script>":                            {ast.CtxText},
		"<style></style>":                              {ast.CtxText},
		"<script>s{{a}}</script>{{a}}":                 {ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		"<style>s{{a}}</style>{{a}}":                   {ast.CtxText, ast.CtxCSS, ast.CtxCSS, ast.CtxCSS, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<style>s{{ render "a" }}t</style>`:            {ast.CtxText, ast.CtxCSS, ast.CtxCSS, ast.CtxCSS, ast.CtxCSS, ast.CtxText},
		`<script>s{{ render "a" }}t</script>`:          {ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxText},
		`<style a="{{b}}"></style>`:                    {ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxText},
		`<style a="b">{{1}}</style>`:                   {ast.CtxText, ast.CtxCSS, ast.CtxCSS, ast.CtxCSS, ast.CtxText},
		`<script a="{{b}}"></script>`:                  {ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxText},
		`<script a="b">{{1}}</script>`:                 {ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxText},
		`<![CDATA[<script>{{1}}</script>]]>`:           {ast.CtxText},
		`a<![CDATA[<script>{{1}}</script>]]>{{2}}`:     {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<div {{ attr }}>`:                             {ast.CtxText, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxText},
		`<div {{ attr }} {{ attr }}>`:                  {ast.CtxText, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxText, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxText},
		`<div{{ attr }}>`:                              {ast.CtxText, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxText},
		`<div {{ attr }}="45">`:                        {ast.CtxText, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxText},
		`<div "{{ v }}">`:                              {ast.CtxText, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxText},
		`<a href="">`:                                  {ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxText},
		`<A Href="">`:                                  {ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxText},
		`<a href=''>`:                                  {ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxText},
		`<a href="u">`:                                 {ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxText},
		`<a href='u'>`:                                 {ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxText},
		`<a href="{{ u }}">`:                           {ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxText},
		`<a href={{ u }}>`:                             {ast.CtxText, ast.CtxHTMLUnquotedAttr, ast.CtxHTMLUnquotedAttr, ast.CtxHTMLUnquotedAttr, ast.CtxHTMLUnquotedAttr, ast.CtxHTMLUnquotedAttr, ast.CtxText},
		`<a href="a{{ p }}">`:                          {ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxText},
		`<a href="{% if a %}b{% end %}">`:              {ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxText},
		`<a {% if a %}{% end %}>`:                      {ast.CtxText, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxText},
		`<a {% if a %}b{% end %}>`:                     {ast.CtxText, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxText, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxText},
		`<a {% if a %}b=""{% end %}>`:                  {ast.CtxText, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxText, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxText},
		`<a {% if a %}b=''{% end %}>`:                  {ast.CtxText, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxText, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxHTMLTag, ast.CtxText},
		`<a class="{{ a }}">`:                          {ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxText},
		`<a class="c">{{ a }}`:                         {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<a class='c'>{{ a }}`:                         {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<a class=c>{{ a }}`:                           {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<input type="text" disabled class="{{ a }}">`: {ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxText},
		`<input type="text" data-value="{{ a }}">`:     {ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxText},
		"<style>s{{a}}t</style>{{a}}":                  {ast.CtxText, ast.CtxCSS, ast.CtxCSS, ast.CtxCSS, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<style>{{a}}"{{a}}"</style>`:                  {ast.CtxText, ast.CtxCSS, ast.CtxCSS, ast.CtxCSS, ast.CtxText, ast.CtxCSSString, ast.CtxCSSString, ast.CtxCSSString, ast.CtxText},
		`<style>"{{a}}"{{a}}</style>`:                  {ast.CtxText, ast.CtxCSSString, ast.CtxCSSString, ast.CtxCSSString, ast.CtxText, ast.CtxCSS, ast.CtxCSS, ast.CtxCSS, ast.CtxText},
		`<style>{{a}}'{{a}}'</style>`:                  {ast.CtxText, ast.CtxCSS, ast.CtxCSS, ast.CtxCSS, ast.CtxText, ast.CtxCSSString, ast.CtxCSSString, ast.CtxCSSString, ast.CtxText},
		`<style>'{{a}}'{{a}}</style>`:                  {ast.CtxText, ast.CtxCSSString, ast.CtxCSSString, ast.CtxCSSString, ast.CtxText, ast.CtxCSS, ast.CtxCSS, ast.CtxCSS, ast.CtxText},
		`<style>'</style>'{{a}}</style>`:               {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText},
		`<style>"</style>"{{a}}</style>`:               {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText},
		"<script>s{{a}}t</script>{{a}}":                {ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<script>{{a}}"{{a}}"</script>`:                {ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxText, ast.CtxJSString, ast.CtxJSString, ast.CtxJSString, ast.CtxText},
		`<script>"{{a}}"{{a}}</script>`:                {ast.CtxText, ast.CtxJSString, ast.CtxJSString, ast.CtxJSString, ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxText},
		`<script>{{a}}'{{a}}'</script>`:                {ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxText, ast.CtxJSString, ast.CtxJSString, ast.CtxJSString, ast.CtxText},
		`<script>'{{a}}'{{a}}</script>`:                {ast.CtxText, ast.CtxJSString, ast.CtxJSString, ast.CtxJSString, ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxText},
		`<script>'</script>'{{a}}</script>`:            {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText},
		`<script>"</script>"{{a}}</script>`:            {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText},
		`<script async></script>{{ "a" }}`:             {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},

		`<script type="application/ld+json">s{{a}}t</script>{{a}}`:     {ast.CtxText, ast.CtxJSON, ast.CtxJSON, ast.CtxJSON, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<script type="application/ld+json">{{a}}"{{a}}"</script>`:     {ast.CtxText, ast.CtxJSON, ast.CtxJSON, ast.CtxJSON, ast.CtxText, ast.CtxJSONString, ast.CtxJSONString, ast.CtxJSONString, ast.CtxText},
		`<script type="application/ld+json">"{{a}}"{{a}}</script>`:     {ast.CtxText, ast.CtxJSONString, ast.CtxJSONString, ast.CtxJSONString, ast.CtxText, ast.CtxJSON, ast.CtxJSON, ast.CtxJSON, ast.CtxText},
		`<script type="application/ld+json">{{a}}'{{a}}'</script>`:     {ast.CtxText, ast.CtxJSON, ast.CtxJSON, ast.CtxJSON, ast.CtxText, ast.CtxJSON, ast.CtxJSON, ast.CtxJSON, ast.CtxText},
		`<script type="application/ld+json">'{{a}}'{{a}}</script>`:     {ast.CtxText, ast.CtxJSON, ast.CtxJSON, ast.CtxJSON, ast.CtxText, ast.CtxJSON, ast.CtxJSON, ast.CtxJSON, ast.CtxText},
		`<script type="application/ld+json">'</script>'{{a}}</script>`: {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText},
		`<script type="application/ld+json">"</script>"{{a}}</script>`: {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText},
		`<script type="application/ld+json" async></script>{{ "a" }}`:  {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},

		`<script type="application/ld+json">s{{a}}</script>{{a}}`:        {ast.CtxText, ast.CtxJSON, ast.CtxJSON, ast.CtxJSON, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<script type="application/ld+json">s{{ render "a" }}t</script>`: {ast.CtxText, ast.CtxJSON, ast.CtxJSON, ast.CtxJSON, ast.CtxJSON, ast.CtxText},
		`<script type="application/ld+json" a="{{b}}"></script>`:         {ast.CtxText, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxHTMLQuotedAttr, ast.CtxText},
		`<script type="application/ld+json" a="b">{{1}}</script>`:        {ast.CtxText, ast.CtxJSON, ast.CtxJSON, ast.CtxJSON, ast.CtxText},

		// Script tag with type attribute.
		`<script type="text/javascript">s{{a}}</script>{{a}}`:   {ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<script type=" text/JavaScript ">s{{a}}</script>{{a}}`: {ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<script type=text/javascript>s{{a}}</script>{{a}}`:     {ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<script type= text/javascript >s{{a}}</script>{{a}}`:   {ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<script type="">s{{a}}</script>{{a}}`:                  {ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<script type>s{{a}}</script>{{a}}`:                     {ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<script type="text/plain">s{{a}}</script>{{a}}`:        {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<script type=text/plain>s{{a}}</script>{{a}}`:          {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},

		// Style tag with type attribute.
		`<style type="text/css">s{{a}}t</style>{{a}}`:   {ast.CtxText, ast.CtxCSS, ast.CtxCSS, ast.CtxCSS, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<style type=" text/CSS ">s{{a}}t</style>{{a}}`: {ast.CtxText, ast.CtxCSS, ast.CtxCSS, ast.CtxCSS, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<style type=text/css>s{{a}}t</style>{{a}}`:     {ast.CtxText, ast.CtxCSS, ast.CtxCSS, ast.CtxCSS, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<style type="">s{{a}}t</style>{{a}}`:           {ast.CtxText, ast.CtxCSS, ast.CtxCSS, ast.CtxCSS, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<style type>s{{a}}t</style>{{a}}`:              {ast.CtxText, ast.CtxCSS, ast.CtxCSS, ast.CtxCSS, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<style type="text/plain">s{{a}}t</style>{{a}}`: {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},

		// JavaScript module
		`<style type="module">s{{a}}t</style>{{a}}`:   {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<style type='module'>s{{a}}t</style>{{a}}`:   {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<style type=module>s{{a}}t</style>{{a}}`:     {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<style type="Module">s{{a}}t</style>{{a}}`:   {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
		`<style type=" module ">s{{a}}t</style>{{a}}`: {ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText, ast.CtxHTML, ast.CtxHTML, ast.CtxHTML},
	...
	ast.CtxCSS: {
		`a`:                             {ast.CtxText},
		`{{a}}`:                         {ast.CtxCSS, ast.CtxCSS, ast.CtxCSS},
		"<script></script>":             {ast.CtxText},
		"<style></style>":               {ast.CtxText},
		"<script>s{{a}}t</script>{{a}}": {ast.CtxText, ast.CtxCSS, ast.CtxCSS, ast.CtxCSS, ast.CtxText, ast.CtxCSS, ast.CtxCSS, ast.CtxCSS},
	},
	ast.CtxCSSString: {
		`a`:       {ast.CtxText},
		`a{{a}}a`: {ast.CtxText, ast.CtxCSSString, ast.CtxCSSString, ast.CtxCSSString, ast.CtxText},
	},
	ast.CtxJS: {
		`a`:                             {ast.CtxText},
		`{{a}}`:                         {ast.CtxJS, ast.CtxJS, ast.CtxJS},
		"<script></script>":             {ast.CtxText},
		"<style></style>":               {ast.CtxText},
		"<script>s{{a}}t</script>{{a}}": {ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS},
		"<style>s{{a}}t</style>{{a}}":   {ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS},
	},
	ast.CtxJSString: {
		`a`:       {ast.CtxText},
		`a{{a}}a`: {ast.CtxText, ast.CtxJSString, ast.CtxJSString, ast.CtxJSString, ast.CtxText},
	},
	ast.CtxJSON: {
		`a`:                             {ast.CtxText},
		`{{a}}`:                         {ast.CtxJSON, ast.CtxJSON, ast.CtxJSON},
		"<script></script>":             {ast.CtxText},
		"<style></style>":               {ast.CtxText},
		"<script>s{{a}}t</script>{{a}}": {ast.CtxText, ast.CtxJSON, ast.CtxJSON, ast.CtxJSON, ast.CtxText, ast.CtxJSON, ast.CtxJSON, ast.CtxJSON},
		"<style>s{{a}}t</style>{{a}}":   {ast.CtxText, ast.CtxJSON, ast.CtxJSON, ast.CtxJSON, ast.CtxText, ast.CtxJSON, ast.CtxJSON, ast.CtxJSON},
	},
	ast.CtxJSONString: {
		`a`:       {ast.CtxText},
		`a{{a}}a`: {ast.CtxText, ast.CtxJSONString, ast.CtxJSONString, ast.CtxJSONString, ast.CtxText},
	},
	ast.CtxMarkdown: {
		`a`:                             {ast.CtxText},
		`a{{a}}a`:                       {ast.CtxText, ast.CtxMarkdown, ast.CtxMarkdown, ast.CtxMarkdown, ast.CtxText},
		"\ta{{a}}\na{{a}}":              {ast.CtxText, ast.CtxMarkdownTabCodeBlock, ast.CtxMarkdownTabCodeBlock, ast.CtxMarkdownTabCodeBlock, ast.CtxText, ast.CtxMarkdown, ast.CtxMarkdown, ast.CtxMarkdown},
		"\ta{{a}}\n\ta{{a}}":            {ast.CtxText, ast.CtxMarkdownTabCodeBlock, ast.CtxMarkdownTabCodeBlock, ast.CtxMarkdownTabCodeBlock, ast.CtxText, ast.CtxMarkdownTabCodeBlock, ast.CtxMarkdownTabCodeBlock, ast.CtxMarkdownTabCodeBlock},
		"    a{{a}}\na{{a}}":            {ast.CtxText, ast.CtxMarkdownSpacesCodeBlock, ast.CtxMarkdownSpacesCodeBlock, ast.CtxMarkdownSpacesCodeBlock, ast.CtxText, ast.CtxMarkdown, ast.CtxMarkdown, ast.CtxMarkdown},
		"    a{{a}}\n    a{{a}}":        {ast.CtxText, ast.CtxMarkdownSpacesCodeBlock, ast.CtxMarkdownSpacesCodeBlock, ast.CtxMarkdownSpacesCodeBlock, ast.CtxText, ast.CtxMarkdownSpacesCodeBlock, ast.CtxMarkdownSpacesCodeBlock, ast.CtxMarkdownSpacesCodeBlock},
		"a\n\t{{a}}":                    {ast.CtxText, ast.CtxMarkdown, ast.CtxMarkdown, ast.CtxMarkdown},
		" \t\n\t{{a}}":                  {ast.CtxText, ast.CtxMarkdownTabCodeBlock, ast.CtxMarkdownTabCodeBlock, ast.CtxMarkdownTabCodeBlock},
		"\t \n    {{a}}":                {ast.CtxText, ast.CtxMarkdownSpacesCodeBlock, ast.CtxMarkdownSpacesCodeBlock, ast.CtxMarkdownSpacesCodeBlock},
		"{# #}\n\t{{a}}":                {ast.CtxMarkdown, ast.CtxText, ast.CtxMarkdown, ast.CtxMarkdown, ast.CtxMarkdown},
		"<style>s{{a}}t</style>{{a}}":   {ast.CtxText, ast.CtxCSS, ast.CtxCSS, ast.CtxCSS, ast.CtxText, ast.CtxMarkdown, ast.CtxMarkdown, ast.CtxMarkdown},
		"<script>s{{a}}t</script>{{a}}": {ast.CtxText, ast.CtxJS, ast.CtxJS, ast.CtxJS, ast.CtxText, ast.CtxMarkdown, ast.CtxMarkdown, ast.CtxMarkdown},
		`<script type="application/ld+json">s{{a}}t</script>{{a}}`: {ast.CtxText, ast.CtxJSON, ast.CtxJSON, ast.CtxJSON, ast.CtxText, ast.CtxMarkdown, ast.CtxMarkdown, ast.CtxMarkdown},
		`a\{{a}\}a`:                {ast.CtxText},
		`a\<a href="{{a}}}">s</a>`: {ast.CtxText, ast.CtxMarkdown, ast.CtxMarkdown, ast.CtxMarkdown, ast.CtxText},
		"a\\\n{{a}}":               {ast.CtxText, ast.CtxMarkdown, ast.CtxMarkdown, ast.CtxMarkdown},
		`a\`:                       {ast.CtxText},
		"a\n\\[\n\t{{a}}":          {ast.CtxText, ast.CtxMarkdown, ast.CtxMarkdown, ast.CtxMarkdown},
		"\t\\{{a}}":                {ast.CtxText, ast.CtxMarkdownTabCodeBlock, ast.CtxMarkdownTabCodeBlock, ast.CtxMarkdownTabCodeBlock},
	},
	ast.CtxMarkdownTabCodeBlock: {
		`a`:       {ast.CtxText},
		`{{a}}`:   {ast.CtxMarkdownTabCodeBlock, ast.CtxMarkdownTabCodeBlock, ast.CtxMarkdownTabCodeBlock},
		`a{{a}}a`: {ast.CtxText, ast.CtxMarkdownTabCodeBlock, ast.CtxMarkdownTabCodeBlock, ast.CtxMarkdownTabCodeBlock, ast.CtxText},
		`\{{a}}`:  {ast.CtxText, ast.CtxMarkdownTabCodeBlock, ast.CtxMarkdownTabCodeBlock, ast.CtxMarkdownTabCodeBlock},
	},
	ast.CtxMarkdownSpacesCodeBlock: {
		`a`:       {ast.CtxText},
		`{{a}}`:   {ast.CtxMarkdownSpacesCodeBlock, ast.CtxMarkdownSpacesCodeBlock, ast.CtxMarkdownSpacesCodeBlock},
		`a{{a}}a`: {ast.CtxText, ast.CtxMarkdownSpacesCodeBlock, ast.CtxMarkdownSpacesCodeBlock, ast.CtxMarkdownSpacesCodeBlock, ast.CtxText},
		`\{{a}}`:  {ast.CtxText, ast.CtxMarkdownSpacesCodeBlock, ast.CtxMarkdownSpacesCodeBlock, ast.CtxMarkdownSpacesCodeBlock},
	},
}

var macroContextTests = map[string][]ast.Ctx{
	// Check context for '%}' tokens only.
	"{% macro a %}{% end %}":                                                 {ast.CtxText, ast.CtxText},
	"{% macro a html %}{% end %}":                                            {ast.CtxHTML, ast.CtxText},
	"{% macro a css %}{% end %}":                                             {ast.CtxCSS, ast.CtxText},
	"{% macro a js %}{% end %}":                                              {ast.CtxJS, ast.CtxText},
	"{% macro a json %}{% end %}":                                            {ast.CtxJSON, ast.CtxText},
	"{% macro a markdown %}{% end %}":                                        {ast.CtxMarkdown, ast.CtxText},
	"{% macro a html %}{% macro b %}{% end %}{% end %}":                      {ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText},
	"{% macro a %}{% macro b css %}{% end %}{% end %}":                       {ast.CtxText, ast.CtxCSS, ast.CtxText, ast.CtxText},
	"{% macro a html %}{% macro b css %}{% end %}{% end %}":                  {ast.CtxHTML, ast.CtxCSS, ast.CtxHTML, ast.CtxText},
	"{% macro a html %}{% if true %}{% end %}{% end %}":                      {ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText},
	"{% macro a html %}{% for %}{% end %}{% end %}":                          {ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText},
	"{% macro a html %}{% switch %}{% end %}{% end %}":                       {ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText},
	"{% macro a html %}{% select %}{% end %}{% end %}":                       {ast.CtxHTML, ast.CtxHTML, ast.CtxHTML, ast.CtxText},
	"{% macro a html %}{% var b int %}{% end %}":                             {ast.CtxHTML, ast.CtxHTML, ast.CtxText},
	"{% macro html %}{% end %}":                                              {ast.CtxText, ast.CtxText},
	"{% macro html html %}{% end %}":                                         {ast.CtxHTML, ast.CtxText},
	"{% macro a(b html) %}{% end %}":                                         {ast.CtxText, ast.CtxText},
	"{% macro a(b html) css %}{% end %}":                                     {ast.CtxCSS, ast.CtxText},
	"{% macro /* */ html %}{% end %}":                                        {ast.CtxText, ast.CtxText},
	"{% macro html /* */ %}{% end %}":                                        {ast.CtxText, ast.CtxText},
	"{% macro a js /* */ %}{% end %}":                                        {ast.CtxJS, ast.CtxText},
	"{% macro a\njs\n%}{% end %}":                                            {ast.CtxJS, ast.CtxText},
	"{% macro a\njs\n// comment\n%}{% end %}":                                {ast.CtxJS, ast.CtxText},
	"{% macro a js %}{% for %}{% macro b css %}{% end %}{% end %}{% end %}":  {ast.CtxJS, ast.CtxJS, ast.CtxCSS, ast.CtxJS, ast.CtxJS, ast.CtxText},
	"{% if a %}{% macro b css %}{% end %}{% macro c js %}{% end %}{% end %}": {ast.CtxText, ast.CtxCSS, ast.CtxText, ast.CtxJS, ast.CtxText, ast.CtxText},
}
