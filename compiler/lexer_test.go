...
var typeTests = map[string][]tokenTyp{
	...
	"{% partial \"\" %}":           {tokenStartStatement, tokenPartial, tokenInterpretedString, tokenEndStatement},
...
var contextTests = map[ast.Context]map[string][]ast.Context{
	...
	ast.ContextHTML: {
		...
		`<style>s{% partial "a" %}t</style>`:           {ast.ContextText, ast.ContextCSS, ast.ContextCSS, ast.ContextCSS, ast.ContextCSS, ast.ContextText},
		`<script>s{% partial "a" %}t</script>`:         {ast.ContextText, ast.ContextJS, ast.ContextJS, ast.ContextJS, ast.ContextJS, ast.ContextText},
		...
		`<script type="application/ld+json">s{% partial "a" %}t</script>`: {ast.ContextText, ast.ContextJSON, ast.ContextJSON, ast.ContextJSON, ast.ContextJSON, ast.ContextText},
