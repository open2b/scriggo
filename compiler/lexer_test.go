...
var typeTestsText = map[string][]tokenTyp{
	...
	"{% a = this; with %}":          {tokenStartStatement, tokenIdentifier, tokenSimpleAssignment, tokenIdentifier, tokenSemicolon, tokenUsing, tokenEndStatement},
	"{% a = with %}":                {tokenStartStatement, tokenIdentifier, tokenSimpleAssignment, tokenUsing, tokenEndStatement},
	...
	"{% a = this using %}":          {tokenStartStatement, tokenIdentifier, tokenSimpleAssignment, tokenIdentifier, tokenUsing, tokenEndStatement},
	"{% a = this() using macro %}":  {tokenStartStatement, tokenIdentifier, tokenSimpleAssignment, tokenIdentifier, tokenLeftParenthesis, tokenRightParenthesis, tokenUsing, tokenMacro, tokenEndStatement},
