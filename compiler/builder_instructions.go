...
//     show(value, ctx)
//
func (builder *functionBuilder) emitShow(v int8, ctx ast.Context, inURL, isURLSet bool) {
	c := encodeRenderContext(ctx, inURL, isURLSet)
	builder.fn.Body = append(builder.fn.Body, runtime.Instruction{Op: runtime.OpShow, A: v, C: int8(c)})
}
