...
var Package = scrigo.Package{
	...
	"FlagBroadcast": scrigo.Constant(original.FlagBroadcast, nil),
	"FlagLoopback": scrigo.Constant(original.FlagLoopback, nil),
	"FlagMulticast": scrigo.Constant(original.FlagMulticast, nil),
	"FlagPointToPoint": scrigo.Constant(original.FlagPointToPoint, nil),
	"FlagUp": scrigo.Constant(original.FlagUp, nil),
	...
	"IPv4len": scrigo.Constant(original.IPv4len, nil),
	"IPv4zero": &original.IPv4zero,
	"IPv6interfacelocalallnodes": &original.IPv6interfacelocalallnodes,
	"IPv6len": scrigo.Constant(original.IPv6len, nil),
