...
func TestParse(t *testing.T) {
	cases := map[string]*scriggofile{
		...
		"EMBEDDED\nIMPORT a AS main UNCAPITALIZED":                     {embedded: true, imports: []importInstruction{{path: "a", asPath: "main", uncapitalized: true}}},
		...
		"EMBEDDED\nIMPORT a AS main UNCAPITALIZED EXPORTING Sleep":     {embedded: true, imports: []importInstruction{{path: "a", asPath: "main", uncapitalized: true, export: []string{"Sleep"}}}},
		"EMBEDDED\nIMPORT a EXPORTING Sleep Duration":                  {embedded: true, imports: []importInstruction{{path: "a", export: []string{"Sleep", "Duration"}}}},
		"EMBEDDED\nIMPORT a AS main UNCAPITALIZED NOT EXPORTING Sleep": {embedded: true, imports: []importInstruction{{path: "a", asPath: "main", uncapitalized: true, notExport: []string{"Sleep"}}}},
