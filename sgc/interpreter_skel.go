...
const interpreterSkel = `// Copyright (c) 2019 Open2b Software Snc. All rights reserved.
		...
		// File generated by Scriggo sgc command.
		...
		func main() {
			...
			if ext != ".go" && ext != ".sgc" && ext != ".html" {
				fmt.Printf("%s: extension must be \".go\" for main packages, \".sgc\" for scripts and \".html\" for template pages\n", file)
				os.Exit(-1)
			}
