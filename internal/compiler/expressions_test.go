...
var exprTests = []struct {
	...
	{"1+2*3+1", ast.NewBinaryOperator(p(1, 6, 0, 6), ast.OperatorAddition,
		ast.NewBinaryOperator(p(1, 2, 0, 4), ast.OperatorAddition,
			...
			ast.NewBinaryOperator(p(1, 4, 2, 4), ast.OperatorMultiplication,
				ast.NewInt(p(1, 3, 2, 2), big.NewInt(2)),
				ast.NewInt(p(1, 5, 4, 4), big.NewInt(3)))),
		ast.NewInt(p(1, 7, 6, 6), big.NewInt(1)))},
	...
	{"1&2", ast.NewBinaryOperator(p(1, 2, 0, 2), ast.OperatorAnd, ast.NewInt(p(1, 1, 0, 0), big.NewInt(1)), ast.NewInt(p(1, 3, 2, 2), big.NewInt(2)))},
	{"1|2", ast.NewBinaryOperator(p(1, 2, 0, 2), ast.OperatorOr, ast.NewInt(p(1, 1, 0, 0), big.NewInt(1)), ast.NewInt(p(1, 3, 2, 2), big.NewInt(2)))},
	{"1^2", ast.NewBinaryOperator(p(1, 2, 0, 2), ast.OperatorXor, ast.NewInt(p(1, 1, 0, 0), big.NewInt(1)), ast.NewInt(p(1, 3, 2, 2), big.NewInt(2)))},
	...
	{"a(1)", ast.NewCall(p(1, 2, 0, 3), ast.NewIdentifier(p(1, 1, 0, 0), "a"), []ast.Expression{ast.NewInt(p(1, 3, 2, 2), big.NewInt(1))}, false)},
	{"a(1,2)", ast.NewCall(p(1, 2, 0, 5), ast.NewIdentifier(p(1, 1, 0, 0), "a"),
		[]ast.Expression{ast.NewInt(p(1, 3, 2, 2), big.NewInt(1)), ast.NewInt(p(1, 5, 4, 4), big.NewInt(2))}, false)},
	...
	{"a[:2]", ast.NewSlicing(p(1, 2, 0, 4), ast.NewIdentifier(p(1, 1, 0, 0), "a"), nil, ast.NewInt(p(1, 4, 3, 3), big.NewInt(2)), nil, false)},
	{"a[1:]", ast.NewSlicing(p(1, 2, 0, 4), ast.NewIdentifier(p(1, 1, 0, 0), "a"), ast.NewInt(p(1, 3, 2, 2), big.NewInt(1)), nil, nil, false)},
	{"a[1:2]", ast.NewSlicing(p(1, 2, 0, 5), ast.NewIdentifier(p(1, 1, 0, 0), "a"), ast.NewInt(p(1, 3, 2, 2), big.NewInt(1)), ast.NewInt(p(1, 5, 4, 4), big.NewInt(2)), nil, false)},
	{"a[1:2:3]", ast.NewSlicing(p(1, 2, 0, 7), ast.NewIdentifier(p(1, 1, 0, 0), "a"), ast.NewInt(p(1, 3, 2, 2), big.NewInt(1)), ast.NewInt(p(1, 5, 4, 4), big.NewInt(2)), ast.NewInt(p(1, 7, 6, 6), big.NewInt(3)), true)},
	...
	{"a()*1", ast.NewBinaryOperator(p(1, 4, 0, 4), ast.OperatorMultiplication,
		ast.NewCall(p(1, 2, 0, 2), ast.NewIdentifier(p(1, 1, 0, 0), "a"), []ast.Expression{}, false), ast.NewInt(p(1, 5, 4, 4), big.NewInt(1)))},
	{"1*a()", ast.NewBinaryOperator(p(1, 2, 0, 4), ast.OperatorMultiplication,
		ast.NewInt(p(1, 1, 0, 0), big.NewInt(1)), ast.NewCall(p(1, 4, 2, 4), ast.NewIdentifier(p(1, 3, 2, 2), "a"), []ast.Expression{}, false))},
	...
	{"a[b(1)]", ast.NewIndex(p(1, 2, 0, 6), ast.NewIdentifier(p(1, 1, 0, 0), "a"), ast.NewCall(p(1, 4, 2, 5),
		ast.NewIdentifier(p(1, 3, 2, 2), "b"), []ast.Expression{ast.NewInt(p(1, 5, 4, 4), big.NewInt(1))}, false))},
	{"a(b[1])", ast.NewCall(p(1, 2, 0, 6), ast.NewIdentifier(p(1, 1, 0, 0), "a"), []ast.Expression{
		ast.NewIndex(p(1, 4, 2, 5), ast.NewIdentifier(p(1, 3, 2, 2), "b"), ast.NewInt(p(1, 5, 4, 4), big.NewInt(1)))}, false)},
		...
		ast.NewBinaryOperator(
			...
			ast.NewBinaryOperator(
				...
				ast.NewCall(
					...
					[]ast.Expression{ast.NewInt(p(1, 17, 16, 16), big.NewInt(2))}, false,
				)),
	...
	{"a(\n\t1\t,\n2\t)", ast.NewCall(p(1, 2, 0, 10), ast.NewIdentifier(p(1, 1, 0, 0), "a"), []ast.Expression{
		ast.NewInt(p(2, 2, 4, 4), big.NewInt(1)), ast.NewInt(p(3, 1, 8, 8), big.NewInt(2))}, false)},
