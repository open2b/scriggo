...
var exprTests = []struct {
	...
	{"'a'", ast.NewInt(p(1, 1, 0, 2), 97)},
	{`'\a'`, ast.NewInt(p(1, 1, 0, 3), 7)},
	{`'\b'`, ast.NewInt(p(1, 1, 0, 3), 8)},
	{`'\f'`, ast.NewInt(p(1, 1, 0, 3), 12)},
	{`'\n'`, ast.NewInt(p(1, 1, 0, 3), 10)},
	{`'\r'`, ast.NewInt(p(1, 1, 0, 3), 13)},
	{`'\t'`, ast.NewInt(p(1, 1, 0, 3), 9)},
	{`'\v'`, ast.NewInt(p(1, 1, 0, 3), 11)},
	{`'\\'`, ast.NewInt(p(1, 1, 0, 3), 92)},
	{`'\''`, ast.NewInt(p(1, 1, 0, 3), 39)},
	{`'\x00'`, ast.NewInt(p(1, 1, 0, 5), 0)},
	{`'\x54'`, ast.NewInt(p(1, 1, 0, 5), 84)},
	{`'\xff'`, ast.NewInt(p(1, 1, 0, 5), 255)},
	{`'\xFF'`, ast.NewInt(p(1, 1, 0, 5), 255)},
	{`'\u0000'`, ast.NewInt(p(1, 1, 0, 7), 0)},
	{`'\u0012'`, ast.NewInt(p(1, 1, 0, 7), 18)},
	{`'\u1234'`, ast.NewInt(p(1, 1, 0, 7), 4660)},
	{`'\U00000000'`, ast.NewInt(p(1, 1, 0, 11), 0)},
	{`'\U0010ffff'`, ast.NewInt(p(1, 1, 0, 11), 1114111)},
	{`'\U0010FFFF'`, ast.NewInt(p(1, 1, 0, 11), 1114111)},
	{`'\000'`, ast.NewInt(p(1, 1, 0, 5), 0)},
	{`'\177'`, ast.NewInt(p(1, 1, 0, 5), 127)},
	{`'\377'`, ast.NewInt(p(1, 1, 0, 5), 255)},
