...
var typeTests = map[string][]tokenType{
	...
	"{% a, ok = b.c %}":            {tokenStartStatement, tokenIdentifier, tokenComma, tokenIdentifier, tokenAssignment, tokenIdentifier, tokenPeriod, tokenIdentifier, tokenEndStatement},
	...
	"{% if a = b; a %}":            {tokenStartStatement, tokenIf, tokenIdentifier, tokenAssignment, tokenIdentifier, tokenSemicolon, tokenIdentifier, tokenEndStatement},
	"{% if a, ok = b.c; a %}":      {tokenStartStatement, tokenIf, tokenIdentifier, tokenComma, tokenIdentifier, tokenAssignment, tokenIdentifier, tokenPeriod, tokenIdentifier, tokenSemicolon, tokenIdentifier, tokenEndStatement},
