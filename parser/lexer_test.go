...
var typeTests = map[string][]tokenType{
	...
	"{% var a = 1 %}":                                  {tokenStartStatement, tokenVar, tokenIdentifier, tokenAssignment, tokenDecimal, tokenEndStatement},
	"{% a = 2 %}":                                      {tokenStartStatement, tokenIdentifier, tokenAssignment, tokenDecimal, tokenEndStatement},
	...
	"{{ 3 }}":                                          {tokenStartValue, tokenDecimal, tokenEndValue},
	"{{ -3 }}":                                         {tokenStartValue, tokenSubtraction, tokenDecimal, tokenEndValue},
	"{{ +3 }}":                                         {tokenStartValue, tokenAddition, tokenDecimal, tokenEndValue},
	"{{ 0 }}":                                          {tokenStartValue, tokenDecimal, tokenEndValue},
	"{{ 2147483647 }}":                                 {tokenStartValue, tokenDecimal, tokenEndValue},
	"{{ -2147483648 }}":                                {tokenStartValue, tokenSubtraction, tokenDecimal, tokenEndValue},
	"{{ .0 }}":                                         {tokenStartValue, tokenDecimal, tokenEndValue},
	"{{ 0. }}":                                         {tokenStartValue, tokenDecimal, tokenEndValue},
	...
	"{{ a[5] }}":                                       {tokenStartValue, tokenIdentifier, tokenLeftBrackets, tokenDecimal, tokenRightBrackets, tokenEndValue},
	"{{ a[:] }}":                                       {tokenStartValue, tokenIdentifier, tokenLeftBrackets, tokenColon, tokenRightBrackets, tokenEndValue},
	"{{ a[:8] }}":                                      {tokenStartValue, tokenIdentifier, tokenLeftBrackets, tokenColon, tokenDecimal, tokenRightBrackets, tokenEndValue},
	"{{ a[3:] }}":                                      {tokenStartValue, tokenIdentifier, tokenLeftBrackets, tokenDecimal, tokenColon, tokenRightBrackets, tokenEndValue},
	"{{ a[3:8] }}":                                     {tokenStartValue, tokenIdentifier, tokenLeftBrackets, tokenDecimal, tokenColon, tokenDecimal, tokenRightBrackets, tokenEndValue},
	"{{ a() }}":                                        {tokenStartValue, tokenIdentifier, tokenLeftParenthesis, tokenRightParenthesis, tokenEndValue},
	"{{ a(1) }}":                                       {tokenStartValue, tokenIdentifier, tokenLeftParenthesis, tokenDecimal, tokenRightParenthesis, tokenEndValue},
	"{{ a(1,2) }}":                                     {tokenStartValue, tokenIdentifier, tokenLeftParenthesis, tokenDecimal, tokenComma, tokenDecimal, tokenRightParenthesis, tokenEndValue},
	...
	"{{ `\\t` }}":                                      {tokenStartValue, tokenRawString, tokenEndValue},
	"{{ ( 1 + 2 ) * 3 }}": {tokenStartValue, tokenLeftParenthesis, tokenDecimal, tokenAddition, tokenDecimal, tokenRightParenthesis,
		tokenMultiplication, tokenDecimal, tokenEndValue},
}
