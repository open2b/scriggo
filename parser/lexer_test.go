...
var typeTests = map[string][]tokenType{
	...
	"{% a = 2 %}":                  {tokenStartStatement, tokenIdentifier, tokenSimpleAssignment, tokenNumber, tokenEndStatement},
	...
	"{% case 42 %}":                {tokenStartStatement, tokenCase, tokenNumber, tokenEndStatement},
	"{% case a %}":                 {tokenStartStatement, tokenCase, tokenIdentifier, tokenEndStatement},
	"{% case a < 20 %}":            {tokenStartStatement, tokenCase, tokenIdentifier, tokenLess, tokenNumber, tokenEndStatement},
	...
	"{% switch a := 5; a %}":       {tokenStartStatement, tokenSwitch, tokenIdentifier, tokenDeclaration, tokenNumber, tokenSemicolon, tokenIdentifier, tokenEndStatement},
	"{% switch a %}":               {tokenStartStatement, tokenSwitch, tokenIdentifier, tokenEndStatement},
	"{% switch a.(type) %}":        {tokenStartStatement, tokenSwitch, tokenIdentifier, tokenPeriod, tokenLeftParenthesis, tokenSwitchType, tokenRightParenthesis, tokenEndStatement},
	"{% switch v := a.(type) %}":   {tokenStartStatement, tokenSwitch, tokenIdentifier, tokenDeclaration, tokenIdentifier, tokenPeriod, tokenLeftParenthesis, tokenSwitchType, tokenRightParenthesis, tokenEndStatement},
	...
	"{{ 'j' }}":             {tokenStartValue, tokenRuneLiteral, tokenEndValue},
	"{{ '\\n' }}":           {tokenStartValue, tokenRuneLiteral, tokenEndValue},
	"{{ '\\106' }}":         {tokenStartValue, tokenRuneLiteral, tokenEndValue},
	"{{ '\\x6a' }}":         {tokenStartValue, tokenRuneLiteral, tokenEndValue},
	"{{ '\\x6A' }}":         {tokenStartValue, tokenRuneLiteral, tokenEndValue},
	"{{ '\\377' }}":         {tokenStartValue, tokenRuneLiteral, tokenEndValue},
	"{{ '\\u006A' }}":       {tokenStartValue, tokenRuneLiteral, tokenEndValue},
	"{{ '\\U0000006A' }}":   {tokenStartValue, tokenRuneLiteral, tokenEndValue},
