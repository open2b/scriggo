...
const (
	...
	PropertyGoImplemented                                  // is implemented in Go
)
...
// GoImplemented reports whether it is implemented in Go.
func (ti *TypeInfo) GoImplemented() bool {
	return ti.Properties&PropertyGoImplemented != 0
}
