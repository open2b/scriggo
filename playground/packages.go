...
func init() {
	...
	decs["BestCompression"] = UntypedConstant("9")
	decs["BestSpeed"] = UntypedConstant("1")
	decs["CorruptInputError"] = reflect.TypeOf((*flate.CorruptInputError)(nil)).Elem()
	decs["DefaultCompression"] = UntypedConstant("-1")
	decs["HuffmanOnly"] = UntypedConstant("-2")
	...
	decs["NoCompression"] = UntypedConstant("0")
	...
	// "crypto/aes"
	decs = make(map[string]interface{}, 3)
	decs["BlockSize"] = UntypedConstant("16")
	...
	decs["BlockSize"] = UntypedConstant("8")
	...
	decs["PSSSaltLengthAuto"] = UntypedConstant("0")
	decs["PSSSaltLengthEqualsHash"] = UntypedConstant("-1")
	...
	decs["Size"] = UntypedConstant("32")
	decs["Size224"] = UntypedConstant("28")
	...
	// "crypto/sha512"
	decs = make(map[string]interface{}, 13)
	decs["BlockSize"] = UntypedConstant("128")
	decs["New"] = sha512.New
	decs["New384"] = sha512.New384
	decs["New512_224"] = sha512.New512_224
	decs["New512_256"] = sha512.New512_256
	decs["Size"] = UntypedConstant("64")
	decs["Size224"] = UntypedConstant("28")
	decs["Size256"] = UntypedConstant("32")
	decs["Size384"] = UntypedConstant("48")
	...
	decs["VersionSSL30"] = UntypedConstant("768")
	decs["VersionTLS10"] = UntypedConstant("769")
	decs["VersionTLS11"] = UntypedConstant("770")
	decs["VersionTLS12"] = UntypedConstant("771")
	decs["VersionTLS13"] = UntypedConstant("772")
	...
	decs["ARM_MAGIC_TRAMP_NUMBER"] = UntypedConstant("1543503875")
	...
	decs["EI_ABIVERSION"] = UntypedConstant("8")
	decs["EI_CLASS"] = UntypedConstant("4")
	decs["EI_DATA"] = UntypedConstant("5")
	decs["EI_NIDENT"] = UntypedConstant("16")
	decs["EI_OSABI"] = UntypedConstant("7")
	decs["EI_PAD"] = UntypedConstant("9")
	decs["EI_VERSION"] = UntypedConstant("6")
	...
	decs["ELFMAG"] = UntypedConstant("\"\\u007fELF\"")
	...
	decs["Sym32Size"] = UntypedConstant("16")
	decs["Sym64"] = reflect.TypeOf((*elf.Sym64)(nil)).Elem()
	decs["Sym64Size"] = UntypedConstant("24")
	...
	decs["COFFSymbolSize"] = UntypedConstant("18")
	...
	decs["IMAGE_DIRECTORY_ENTRY_ARCHITECTURE"] = UntypedConstant("7")
	decs["IMAGE_DIRECTORY_ENTRY_BASERELOC"] = UntypedConstant("5")
	decs["IMAGE_DIRECTORY_ENTRY_BOUND_IMPORT"] = UntypedConstant("11")
	decs["IMAGE_DIRECTORY_ENTRY_COM_DESCRIPTOR"] = UntypedConstant("14")
	decs["IMAGE_DIRECTORY_ENTRY_DEBUG"] = UntypedConstant("6")
	decs["IMAGE_DIRECTORY_ENTRY_DELAY_IMPORT"] = UntypedConstant("13")
	decs["IMAGE_DIRECTORY_ENTRY_EXCEPTION"] = UntypedConstant("3")
	decs["IMAGE_DIRECTORY_ENTRY_EXPORT"] = UntypedConstant("0")
	decs["IMAGE_DIRECTORY_ENTRY_GLOBALPTR"] = UntypedConstant("8")
	decs["IMAGE_DIRECTORY_ENTRY_IAT"] = UntypedConstant("12")
	decs["IMAGE_DIRECTORY_ENTRY_IMPORT"] = UntypedConstant("1")
	decs["IMAGE_DIRECTORY_ENTRY_LOAD_CONFIG"] = UntypedConstant("10")
	decs["IMAGE_DIRECTORY_ENTRY_RESOURCE"] = UntypedConstant("2")
	decs["IMAGE_DIRECTORY_ENTRY_SECURITY"] = UntypedConstant("4")
	decs["IMAGE_DIRECTORY_ENTRY_TLS"] = UntypedConstant("9")
	decs["IMAGE_FILE_MACHINE_AM33"] = UntypedConstant("467")
	decs["IMAGE_FILE_MACHINE_AMD64"] = UntypedConstant("34404")
	decs["IMAGE_FILE_MACHINE_ARM"] = UntypedConstant("448")
	decs["IMAGE_FILE_MACHINE_ARM64"] = UntypedConstant("43620")
	decs["IMAGE_FILE_MACHINE_ARMNT"] = UntypedConstant("452")
	decs["IMAGE_FILE_MACHINE_EBC"] = UntypedConstant("3772")
	decs["IMAGE_FILE_MACHINE_I386"] = UntypedConstant("332")
	decs["IMAGE_FILE_MACHINE_IA64"] = UntypedConstant("512")
	decs["IMAGE_FILE_MACHINE_M32R"] = UntypedConstant("36929")
	decs["IMAGE_FILE_MACHINE_MIPS16"] = UntypedConstant("614")
	decs["IMAGE_FILE_MACHINE_MIPSFPU"] = UntypedConstant("870")
	decs["IMAGE_FILE_MACHINE_MIPSFPU16"] = UntypedConstant("1126")
	decs["IMAGE_FILE_MACHINE_POWERPC"] = UntypedConstant("496")
	decs["IMAGE_FILE_MACHINE_POWERPCFP"] = UntypedConstant("497")
	decs["IMAGE_FILE_MACHINE_R4000"] = UntypedConstant("358")
	decs["IMAGE_FILE_MACHINE_SH3"] = UntypedConstant("418")
	decs["IMAGE_FILE_MACHINE_SH3DSP"] = UntypedConstant("419")
	decs["IMAGE_FILE_MACHINE_SH4"] = UntypedConstant("422")
	decs["IMAGE_FILE_MACHINE_SH5"] = UntypedConstant("424")
	decs["IMAGE_FILE_MACHINE_THUMB"] = UntypedConstant("450")
	decs["IMAGE_FILE_MACHINE_UNKNOWN"] = UntypedConstant("0")
	decs["IMAGE_FILE_MACHINE_WCEMIPSV2"] = UntypedConstant("361")
	...
	decs["Magic386"] = UntypedConstant("491")
	decs["Magic64"] = UntypedConstant("32768")
	decs["MagicAMD64"] = UntypedConstant("35479")
	decs["MagicARM"] = UntypedConstant("1607")
	...
	decs["ClassApplication"] = UntypedConstant("1")
	decs["ClassContextSpecific"] = UntypedConstant("2")
	decs["ClassPrivate"] = UntypedConstant("3")
	decs["ClassUniversal"] = UntypedConstant("0")
	...
	decs["TagBMPString"] = UntypedConstant("30")
	decs["TagBitString"] = UntypedConstant("3")
	decs["TagBoolean"] = UntypedConstant("1")
	decs["TagEnum"] = UntypedConstant("10")
	decs["TagGeneralString"] = UntypedConstant("27")
	decs["TagGeneralizedTime"] = UntypedConstant("24")
	decs["TagIA5String"] = UntypedConstant("22")
	decs["TagInteger"] = UntypedConstant("2")
	decs["TagNull"] = UntypedConstant("5")
	decs["TagNumericString"] = UntypedConstant("18")
	decs["TagOID"] = UntypedConstant("6")
	decs["TagOctetString"] = UntypedConstant("4")
	decs["TagPrintableString"] = UntypedConstant("19")
	decs["TagSequence"] = UntypedConstant("16")
	decs["TagSet"] = UntypedConstant("17")
	decs["TagT61String"] = UntypedConstant("20")
	decs["TagUTCTime"] = UntypedConstant("23")
	decs["TagUTF8String"] = UntypedConstant("12")
	...
	decs["MaxVarintLen16"] = UntypedConstant("3")
	decs["MaxVarintLen32"] = UntypedConstant("5")
	decs["MaxVarintLen64"] = UntypedConstant("10")
	...
	decs["Header"] = UntypedConstant("\"<?xml version=\\\"1.0\\\" encoding=\\\"UTF-8\\\"?>\\n\"")
	...
	decs["GTR"] = token.GTR
	decs["HighestPrec"] = UntypedConstant("7")
	...
	decs["LowestPrec"] = UntypedConstant("0")
	decs["MAP"] = token.MAP
	decs["MUL"] = token.MUL
	...
	decs["UnaryPrec"] = UntypedConstant("6")
	decs["VAR"] = token.VAR
	decs["XOR"] = token.XOR
	...
	// "hash/crc32"
	decs = make(map[string]interface{}, 12)
	decs["Castagnoli"] = UntypedConstant("2197175160")
	decs["Checksum"] = crc32.Checksum
	decs["ChecksumIEEE"] = crc32.ChecksumIEEE
	decs["IEEE"] = UntypedConstant("3988292384")
	decs["IEEETable"] = &crc32.IEEETable
	decs["Koopman"] = UntypedConstant("3945912366")
	...
	decs["ECMA"] = UntypedConstant("14514072000185962306")
	decs["ISO"] = UntypedConstant("15564440312192434176")
	decs["MakeTable"] = crc64.MakeTable
	decs["New"] = crc64.New
	decs["Size"] = UntypedConstant("8")
	...
	decs["DisposalBackground"] = UntypedConstant("2")
	decs["DisposalNone"] = UntypedConstant("1")
	decs["DisposalPrevious"] = UntypedConstant("3")
	...
	decs["DefaultQuality"] = UntypedConstant("75")
	...
	decs["SeekCurrent"] = UntypedConstant("1")
	decs["SeekEnd"] = UntypedConstant("2")
	decs["SeekStart"] = UntypedConstant("0")
	...
	decs["LUTC"] = UntypedConstant("32")
	decs["Ldate"] = UntypedConstant("1")
	decs["Llongfile"] = UntypedConstant("8")
	decs["Lmicroseconds"] = UntypedConstant("4")
	decs["Lmsgprefix"] = UntypedConstant("64")
	decs["Logger"] = reflect.TypeOf((*log.Logger)(nil)).Elem()
	decs["Lshortfile"] = UntypedConstant("16")
	decs["LstdFlags"] = UntypedConstant("3")
	decs["Ltime"] = UntypedConstant("2")
	decs["New"] = log.New
	...
	decs["MaxBase"] = UntypedConstant("62")
	decs["MaxExp"] = UntypedConstant("2147483647")
	decs["MaxPrec"] = UntypedConstant("4294967295")
	decs["MinExp"] = UntypedConstant("-2147483648")
	...
	decs["UintSize"] = UntypedConstant("64")
	...
	decs["DefaultMaxHeaderBytes"] = UntypedConstant("1048576")
	decs["DefaultMaxIdleConnsPerHost"] = UntypedConstant("2")
	...
	decs["MethodConnect"] = UntypedConstant("\"CONNECT\"")
	decs["MethodDelete"] = UntypedConstant("\"DELETE\"")
	decs["MethodGet"] = UntypedConstant("\"GET\"")
	decs["MethodHead"] = UntypedConstant("\"HEAD\"")
	decs["MethodOptions"] = UntypedConstant("\"OPTIONS\"")
	decs["MethodPatch"] = UntypedConstant("\"PATCH\"")
	decs["MethodPost"] = UntypedConstant("\"POST\"")
	decs["MethodPut"] = UntypedConstant("\"PUT\"")
	decs["MethodTrace"] = UntypedConstant("\"TRACE\"")
	...
	decs["StatusAccepted"] = UntypedConstant("202")
	decs["StatusAlreadyReported"] = UntypedConstant("208")
	decs["StatusBadGateway"] = UntypedConstant("502")
	decs["StatusBadRequest"] = UntypedConstant("400")
	decs["StatusConflict"] = UntypedConstant("409")
	decs["StatusContinue"] = UntypedConstant("100")
	decs["StatusCreated"] = UntypedConstant("201")
	decs["StatusEarlyHints"] = UntypedConstant("103")
	decs["StatusExpectationFailed"] = UntypedConstant("417")
	decs["StatusFailedDependency"] = UntypedConstant("424")
	decs["StatusForbidden"] = UntypedConstant("403")
	decs["StatusFound"] = UntypedConstant("302")
	decs["StatusGatewayTimeout"] = UntypedConstant("504")
	decs["StatusGone"] = UntypedConstant("410")
	decs["StatusHTTPVersionNotSupported"] = UntypedConstant("505")
	decs["StatusIMUsed"] = UntypedConstant("226")
	decs["StatusInsufficientStorage"] = UntypedConstant("507")
	decs["StatusInternalServerError"] = UntypedConstant("500")
	decs["StatusLengthRequired"] = UntypedConstant("411")
	decs["StatusLocked"] = UntypedConstant("423")
	decs["StatusLoopDetected"] = UntypedConstant("508")
	decs["StatusMethodNotAllowed"] = UntypedConstant("405")
	decs["StatusMisdirectedRequest"] = UntypedConstant("421")
	decs["StatusMovedPermanently"] = UntypedConstant("301")
	decs["StatusMultiStatus"] = UntypedConstant("207")
	decs["StatusMultipleChoices"] = UntypedConstant("300")
	decs["StatusNetworkAuthenticationRequired"] = UntypedConstant("511")
	decs["StatusNoContent"] = UntypedConstant("204")
	decs["StatusNonAuthoritativeInfo"] = UntypedConstant("203")
	decs["StatusNotAcceptable"] = UntypedConstant("406")
	decs["StatusNotExtended"] = UntypedConstant("510")
	decs["StatusNotFound"] = UntypedConstant("404")
	decs["StatusNotImplemented"] = UntypedConstant("501")
	decs["StatusNotModified"] = UntypedConstant("304")
	decs["StatusOK"] = UntypedConstant("200")
	decs["StatusPartialContent"] = UntypedConstant("206")
	decs["StatusPaymentRequired"] = UntypedConstant("402")
	decs["StatusPermanentRedirect"] = UntypedConstant("308")
	decs["StatusPreconditionFailed"] = UntypedConstant("412")
	decs["StatusPreconditionRequired"] = UntypedConstant("428")
	decs["StatusProcessing"] = UntypedConstant("102")
	decs["StatusProxyAuthRequired"] = UntypedConstant("407")
	decs["StatusRequestEntityTooLarge"] = UntypedConstant("413")
	decs["StatusRequestHeaderFieldsTooLarge"] = UntypedConstant("431")
	decs["StatusRequestTimeout"] = UntypedConstant("408")
	decs["StatusRequestURITooLong"] = UntypedConstant("414")
	decs["StatusRequestedRangeNotSatisfiable"] = UntypedConstant("416")
	decs["StatusResetContent"] = UntypedConstant("205")
	decs["StatusSeeOther"] = UntypedConstant("303")
	decs["StatusServiceUnavailable"] = UntypedConstant("503")
	decs["StatusSwitchingProtocols"] = UntypedConstant("101")
	decs["StatusTeapot"] = UntypedConstant("418")
	decs["StatusTemporaryRedirect"] = UntypedConstant("307")
	decs["StatusText"] = http.StatusText
	decs["StatusTooEarly"] = UntypedConstant("425")
	decs["StatusTooManyRequests"] = UntypedConstant("429")
	decs["StatusUnauthorized"] = UntypedConstant("401")
	decs["StatusUnavailableForLegalReasons"] = UntypedConstant("451")
	decs["StatusUnprocessableEntity"] = UntypedConstant("422")
	decs["StatusUnsupportedMediaType"] = UntypedConstant("415")
	decs["StatusUpgradeRequired"] = UntypedConstant("426")
	decs["StatusUseProxy"] = UntypedConstant("305")
	decs["StatusVariantAlsoNegotiates"] = UntypedConstant("506")
	decs["StripPrefix"] = http.StripPrefix
	decs["TimeFormat"] = UntypedConstant("\"Mon, 02 Jan 2006 15:04:05 GMT\"")
	decs["TimeoutHandler"] = http.TimeoutHandler
	decs["TrailerPrefix"] = UntypedConstant("\"Trailer:\"")
	...
	// "net/http/httptest"
	decs = make(map[string]interface{}, 8)
	decs["DefaultRemoteAddr"] = UntypedConstant("\"1.2.3.4\"")
	...
	decs["DefaultDebugPath"] = UntypedConstant("\"/debug/rpc\"")
	decs["DefaultRPCPath"] = UntypedConstant("\"/_goRPC_\"")
	...
	decs["ListSeparator"] = UntypedConstant("58")
	decs["Match"] = filepath.Match
	decs["Rel"] = filepath.Rel
	decs["Separator"] = UntypedConstant("47")
	...
	decs["Compiler"] = UntypedConstant("\"gc\"")
	...
	// "text/scanner"
	decs = make(map[string]interface{}, 21)
	decs["Char"] = UntypedConstant("-5")
	decs["Comment"] = UntypedConstant("-8")
	decs["EOF"] = UntypedConstant("-1")
	decs["Float"] = UntypedConstant("-4")
	decs["GoTokens"] = UntypedConstant("1012")
	decs["GoWhitespace"] = UntypedConstant("4294977024")
	decs["Ident"] = UntypedConstant("-2")
	decs["Int"] = UntypedConstant("-3")
	decs["Position"] = reflect.TypeOf((*scanner_.Position)(nil)).Elem()
	decs["RawString"] = UntypedConstant("-7")
	decs["ScanChars"] = UntypedConstant("32")
	decs["ScanComments"] = UntypedConstant("256")
	decs["ScanFloats"] = UntypedConstant("16")
	decs["ScanIdents"] = UntypedConstant("4")
	decs["ScanInts"] = UntypedConstant("8")
	decs["ScanRawStrings"] = UntypedConstant("128")
	decs["ScanStrings"] = UntypedConstant("64")
	decs["Scanner"] = reflect.TypeOf((*scanner_.Scanner)(nil)).Elem()
	decs["SkipComments"] = UntypedConstant("512")
	decs["String"] = UntypedConstant("-6")
	...
	decs["Escape"] = UntypedConstant("255")
	...
	decs["Version"] = UntypedConstant("\"12.0.0\"")
